...
class CHPCS {
	...
	if($display_controls) {
		...
		$slider_gallery.='<div class="opacity_left"></div><a class="chpcs_prev" id="wa_chpc_slider_prev" href="#"><span>‹</span></a>';

		$slider_gallery.='<div class="opacity_right"></div><a class="chpcs_next" id="wa_chpc_slider_next" href="#"><span>›</span></a>';	
